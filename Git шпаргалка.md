...
git pull - скачать все из текушего репозитория и автоиатически сделать merge с нашей версией.
git init - инициализация работы репозитория
git status - проверка статуса проекта
# Добавим все файлы проекта в наш будующий commit
git add указываем место сохранения
Или так git add --all
=======
# Создание репозитория ^_^

Выполняю домашнее задание, вношу изменения

# Создание идеального репозитория
