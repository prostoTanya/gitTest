...
git pull - скачать все из текушего репозитория и автоматически сделать merge с нашей версией.
...
# Добавим все файлы проекта для отслеживания
Перед добавлением файлов и коммитами **Сохраняемся обязательно!**
git add .
или
git add --all
